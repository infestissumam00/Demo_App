...
import { AppRegistry,View,Text,StyleSheet,Image,TextInput,TouchableOpacity,KeyboardAvoidingView,Picker,ToastAndroid,Slider,Switch,AsyncStorage,renderIf } from 'react-native';
...
componentWillMount()
{
  ...
  const value =  AsyncStorage.getItem('myAccessToken')
  .then((value)=>{
  if (value != null){
